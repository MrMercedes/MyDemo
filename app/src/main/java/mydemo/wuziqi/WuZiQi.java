...
public class WuZiQi extends View {
    ...
    public void init(){
        ...
        Drawable drawable=res.getDrawable(R.drawable.ai);
        drawable.setBounds(0, 0, CHESS_DIAMETER, CHESS_DIAMETER);
        drawable.draw(canvas);
        mChessBW[0] = bitmap;

        drawable = res.getDrawable(R.drawable.you);
        drawable.setBounds(0, 0, CHESS_DIAMETER, CHESS_DIAMETER);
        drawable.draw(canvas);
        mChessBW[1] = bitmap;
